...
gulp.task('watch', function() {  
  ...
  gulp.watch(
      [paths.resources.vue+'*.js', // files contain .js
       paths.resources.vue+'**/*.js', // sub directories with files contain .js
       paths.resources.vue+'**/*.html'], // sub directories with files contain .js
